...
public class CliMenu {
    ...
    public void showWelcomeScreen() {
        drawHeading("Welcome to the FlashcardComponent App!");
    }
    ...
    public void showDeckPage(Deck currentDeck) {
        ...
        if (currentDeck.getDeckSize() == 0) {
            ...
            System.out.println("\"N\" -- Create a New FlashcardComponent");
    ...
    public void showNewFlashcardPage() {
        drawHeading("New FlashcardComponent!");
    }
    ...
    public void askUserToUpdateFlashcardFront(Flashcard flashcard) {
        System.out.println("Old FlashcardComponent Front: " + flashcard.getFront());
    ...
    public void askUserToUpdateFlashcardBack(Flashcard flashcard) {
        System.out.println("Old FlashcardComponent Back: " + flashcard.getBack());
    ...
    public void showFlashcardPage(Flashcard currentFlashcard) {
        drawHeading("Selected FlashcardComponent:");
    ...
    public void showEditFlashcardPage() {
        drawHeading("Editing Selected FlashcardComponent:");
    }
    ...
    public void cardRevisionMessage() {
        System.out.println(" ☆ You Earned 1 Point For Improving That FlashcardComponent! ☆");
    }
